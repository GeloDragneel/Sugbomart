                ...
                <table class="table table-bordered cell-border" id="table_MyOrder">
                    ...
                    <tbody>
                        <?php
                            ...
                            $query = "SELECT a.ID,a.ProductName,a.Price,a.DiscountedPrice,a.Quantity,b.StoreName FROM `products` a INNER JOIN `store` b ON b.ID = a.StoreID WHERE a.StoreID = $StoreID ORDER BY a.ID DESC";
                            if ($result = $mysqli->query($query)) {
                                ...
                                else{echo '<tr><td colspan="5">Product Yet</td></tr>';}
                            }
                        ?>
                    </tbody>
                </table>
